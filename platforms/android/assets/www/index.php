...
<div id="songOptionsOriginal" style="display:none">
    ...
    <img id="moreOptions" onclick="playlistController.showMoreSelectionOptions(event);" ondblclick="event.stopPropagation();"   src="public/img/moreoptions.png" >
