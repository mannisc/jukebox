...
<div id="searchlist" class="clickarea">
    ...
    <ul   data-role="listview" id="searchlistview" class="connectedSortable songlist fast3d" >
        ...
        <li ng-if ="searchController.visible&&searchController.showed&&searchController.showMode!=0&&searchController.showMode<5" onclick="searchController.setShowMode(event,0)" ondblclick="event.stopPropagation();"  class="fadeincomplete hoverable specialplaylistbutton songlisttitlebutton othertopheight stayvisible">
            <a tabindex="-1">
        ...
        <li ng-if ="searchController.visible&&searchController.artists.searchResults.length>0&&searchController.isVisisbleInShowMode(3)" onclick="searchController.setShowMode(event,3)"  ondblclick="event.stopPropagation();"  class="fadeincomplete hoverable specialplaylistbutton songlisttitlebutton  othertopheight stayvisible">
            <a tabindex="-1" ng-class="{loaded:searchController.isOnlyTypeDisplayed(3)}">
        ...
        <li  ng-if ="searchController.visible&&searchController.users.searchResults.length>0&&searchController.isVisisbleInShowMode(4)" onclick="searchController.setShowMode(event,4)"  ondblclick="event.stopPropagation();" class="fadeincomplete hoverable specialplaylistbutton songlisttitlebutton otherbottomheight stayvisible">
    ...
    <form>
        ...
        <div>
            ...
            <div id = "reloadVersionButton" style="margin-right: 10px; margin-left:10px;margin-top:2px;margin-bottom:2px;text-align: center;">
                <a  href="#" class="ReloadVersions  ui-btn  ui-corner-all ui-shadow ui-btn-inline ui-icon-search ui-btn-icon-left ui-btn-a"  id="ReloadVersions" title="ReloadVersions" onclick="mediaController.reloadVersions();" >Search for new versions of this song </a>
            </div>
    ...
    <form>
        <div>
            ...
            <div id = "shareCurrentSongButton" style="margin-left:10px;margin-top:0px;margin-bottom:0px;">
                <a  href="#" style="width:50%;text-indent:-40px!important;" class="ShareCurrentSong  ui-btn   ui-corner-all ui-shadow ui-btn-inline ui-icon-sharemedia ui-btn-icon-left ui-btn-a"  id="ShareCurrentSong" title="Share the current song with your friends" onclick="mediaController.shareCurrentSong();" >Share Song</a>
            </div>
            <div id = "SharePlayQueueButton" style="margin-left:10px;margin-top:0px;margin-bottom:0px;">
                <a  href="#" style="width:50%;text-indent:0px!important;" class="SharePlayQueue  ui-btn  ui-corner-all ui-shadow ui-btn-inline ui-icon-sharemedia ui-btn-icon-left ui-btn-a"  id="SharePlayQueue" title="Share current play queue with your friends" onclick="mediaController.sharePlayQueue();" >Share Play Queue</a>
            </div>
            <div id = "sharePlaylistButton" style="margin-left:10px;margin-top:0px;margin-bottom:0px;">
                <a  href="#"  style="width:50%;text-indent:-30px!important;" class="SharePlaylist  ui-btn  ui-corner-all ui-shadow ui-btn-inline ui-icon-sharemedia ui-btn-icon-left ui-btn-a"  id="SharePlaylist" title="Share your playlists with your friends" onclick="mediaController.sharePlaylist();" >Share Playlist</a>
            </div>
        </div>
    </form>
</div>
